...
registerMooseObject(MOOSEAPPNAME, ADComputeIsotropicElasticityTensorTriangularShell);

InputParameters
ADComputeIsotropicElasticityTensorTriangularShell::validParams()
{
...
void
ADComputeIsotropicElasticityTensorTriangularShell::computeQpProperties()
{
  for (unsigned int t = 0; t < _t_points.size(); ++t)
  {
