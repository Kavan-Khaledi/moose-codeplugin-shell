...
ADComputeOrthotropicElasticityTensorShell::validParams()
{
  ...
  params.addRequiredParam<Real>("poissons_ratio_12",
                                            "in-plane Poisson's ratio for the material.");
  params.addRequiredParam<Real>(
      "youngs_modulus_1", "Young's modulus of the material in direction e1.");
  params.addRequiredParam<Real>(
      "youngs_modulus_2", "Young's modulus of the material in direction e2.");
  params.addRequiredParam<Real>(
      "shear_modulus_12",  "shear modulus of the material in direction e1-e2.");
  params.addRequiredParam<Real>(
      "shear_modulus_13",  "shear modulus of the material in direction e1-e3.");
  params.addRequiredParam<Real>(
      "shear_modulus_23",  "shear modulus of the material in direction e2-e3.");
    ...
    _shear_modulus_23(getParam<Real>("shear_modulus_23"))
{
  ...
  _Cijkl(2, 2, 0, 0) = 0.0;
  _Cijkl(2, 2, 1, 1) = 0.0;
  _Cijkl(1, 2, 1, 2) = _Cijkl(2, 1, 2, 1)=_Cijkl(2, 1, 1, 2)=_Cijkl(1, 2, 2, 1)=_shear_modulus_23;
  _Cijkl(0, 2, 0, 2) = _Cijkl(2, 0, 2, 0)=_Cijkl(2, 0, 0, 2)=_Cijkl(0, 2, 2, 0)=_shear_modulus_13;
  _Cijkl(0, 1, 0, 1) = _Cijkl(1, 0, 1, 0)=_Cijkl(1, 0, 0, 1)=_Cijkl(0, 1, 1, 0)=_shear_modulus_12;
