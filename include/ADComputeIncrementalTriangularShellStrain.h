...
class ADComputeIncrementalTriangularShellStrain : public Material
{
public:
  static InputParameters validParams();

  ADComputeIncrementalTriangularShellStrain(const InputParameters & parameters);
